...
image::Documentation/Pictures/2_W_Onlinediary.png[White-Editor, width=600, height=400, align=center]

image::Documentation/Pictures/3_Dashboard.png[Dark-Dashboard, width=600, height=400, align=center]

image::Documentation/Pictures/3_W_Dashboard.png[White-Dashboard, width=600, height=400, align=center]
